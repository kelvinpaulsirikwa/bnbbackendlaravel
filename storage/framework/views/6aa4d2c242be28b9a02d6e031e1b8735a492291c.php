...
<div class="container-fluid py-4" style="background-color: #f8f9fa; min-height: 100vh;">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4">
        ...
        <a href="<?php echo e(route('adminpages.dashboard')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-8 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white border-0 py-3">
                    <h5 class="mb-0"><i class="bx bx-target-lock me-2"></i>Where you’ve been busiest</h5>
                </div>
                <div class="card-body">
                    <?php if($topAreas->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-sm mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $topAreas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($area->area); ?></td>
                                            <td class="text-end"><?php echo e($area->count); ?></td>
                                        </tr>
                    ...
                    <?php else: ?>
                        <p class="text-muted mb-0">You haven’t contributed in any section yet. Once you do, they’ll show up here.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $recentLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($log->subject_type ?? $log->route_name ?? '—'); ?></td>
...
<?php echo $__env->make('adminpages.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\iuser\Desktop\PROJECTS\BNB PROJECT\bnbbackendlaravel\resources\views/adminpages/authenticated-users-summary.blade.php ENDPATH**/ ?>