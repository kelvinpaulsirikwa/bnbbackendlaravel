            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('adminpages.users.edit', $user->id)); ?>" class="btn btn-warning btn-lg shadow-sm">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 text-center mb-4">
                                <?php if($user->profileimage): ?>
                                    <img src="<?php echo e(asset($user->profileimage)); ?>" alt="Profile" class="rounded-circle shadow" style="width: 120px; height: 120px; object-fit: cover;">
                                <?php else: ?>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0 fw-semibold">#<?php echo e($user->id); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e($user->username); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e($user->useremail); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e($user->telephone ?? 'N/A'); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        ?>
                                        <span class="badge bg-info fs-6"><?php echo e($roleLabels[$user->role] ?? $user->role); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <span class="badge <?php echo e($user->status == 'active' ? 'bg-success' : 'bg-danger'); ?> fs-6">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e($user->createdby ? \App\Models\BnbUser::find($user->createdby)->username ?? 'User #' . $user->createdby : 'System'); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e($user->created_at->format('M d, Y H:i A')); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e($user->updated_at->format('M d, Y H:i A')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <?php if($user->id !== auth()->id()): ?>
                                <form action="<?php echo e(route('adminpages.users.update-status', $user->id)); ?>"
                                    ...
                                    <button type="submit" class="btn btn-danger">
                                        <i class="bx bx-power-off"></i> <?php echo e($user->status === 'active' ? 'Deactivate User' : 'Activate User'); ?>
...
<?php echo $__env->make('adminpages.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\iuser\Desktop\PROJECTS\BNB PROJECT\bnbbackendlaravel\resources\views/adminpages/users/show.blade.php ENDPATH**/ ?>