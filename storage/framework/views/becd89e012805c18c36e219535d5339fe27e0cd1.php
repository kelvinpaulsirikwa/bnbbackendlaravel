...
unset($__errorArgs, $__bag); ?>
                                ...
                                ?>
                                <div class="col-12" id="admin-permissions-wrap" style="display: <?php echo e($currentUserType === 'admin' ? 'block' : 'none'); ?>;">
                                    ...
                                    <div class="border rounded p-3 bg-light">
                                        <?php $__currentLoopData = config('admin_permissions', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-check">
                                                <input class="form-check-input admin-permission-cb" type="checkbox" name="admin_permissions[]" value="<?php echo e($key); ?>" id="admin_perm_<?php echo e($key); ?>" <?php echo e(in_array($key, old('admin_permissions', $user->admin_permissions ?? [])) ? 'checked' : ''); ?>>
