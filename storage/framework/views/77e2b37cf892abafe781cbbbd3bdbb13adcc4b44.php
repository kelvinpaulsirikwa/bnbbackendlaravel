<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-4" style="background-color: white; min-height: 100vh;">
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 mb-0 text-gray-800">Admin Logs</h1>
                        <p class="text-muted mb-0">Track every activity performed by admins</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('adminpages.admin-logs.index')); ?>">
                    <div class="row g-3">
                        <div class="col-md-2">
                            <label for="admin_user_id" class="form-label">User</label>
                            <select class="form-select" id="admin_user_id" name="admin_user_id">
                                <option value="">All admins</option>
                                <?php $__currentLoopData = $adminUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($u->id); ?>" <?php echo e(request('admin_user_id') == $u->id ? 'selected' : ''); ?>>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="search" name="search"
                                   placeholder="Action, description, route..." value="<?php echo e(request('search')); ?>">
                        </div>
                        <div class="col-md-2 d-flex align-items-end">
                            <button type="submit" class="btn btn-outline-primary me-2">
                                <i class="bx bx-search"></i> Filter
                            </button>
                            <a href="<?php echo e(route('adminpages.admin-logs.index')); ?>" class="btn btn-outline-secondary">Clear</a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="card-body p-0">
                                ...
                                <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <?php if($log->adminUser): ?>
                                                <span class="fw-semibold"><?php echo e($log->adminUser->username ?? $log->adminUser->useremail); ?></span>
                                                <br><small class="text-muted"><?php echo e($log->adminUser->useremail); ?></small>
                                            <?php else: ?>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="<?php echo e(route('adminpages.admin-logs.show', $log)); ?>" class="btn btn-sm btn-outline-info" title="View details"><i class="bx bx-show"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mt-3 mb-0">No admin activity logged yet.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('adminpages.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\iuser\Desktop\PROJECTS\BNB PROJECT\bnbbackendlaravel\resources\views/adminpages/admin-logs/index.blade.php ENDPATH**/ ?>