    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Create New Room - <?php echo e($motel->name); ?></h1>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('bnbowner.room-management.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="price_per_night" name="price_per_night" 
                                                   value="<?php echo e(old('price_per_night')); ?>" step="0.01" min="0" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="status" name="status" required>
                                                <option value="free" <?php echo e(old('status', 'free') == 'free' ? 'selected' : ''); ?>>Free</option>
                                                <option value="booked" <?php echo e(old('status') == 'booked' ? 'selected' : ''); ?>>Booked</option>
                                                <option value="maintainace" <?php echo e(old('status') == 'maintainace' ? 'selected' : ''); ?>>Maintenance</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
...
<?php echo $__env->make('layouts.owner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\iuser\Desktop\PROJECTS\BNB PROJECT\bnbbackendlaravel\resources\views/bnbowner/room-management/create.blade.php ENDPATH**/ ?>