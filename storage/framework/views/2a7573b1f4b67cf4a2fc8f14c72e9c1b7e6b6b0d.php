    ...
    <section class="pcs-contact-wrapper">
        ...
        <div class="pcs-container">
            ...
            <div class="pcs-header">
                <span class="pcs-header-badge"><?php echo e(__('website.contact.badge')); ?></span>
                <h2><?php echo e($info['hero']['title'] ?? __('website.contact.hero_title')); ?></h2>
                <p><?php echo e($info['hero']['subtitle'] ?? __('website.contact.hero_subtitle')); ?></p>
            </div>
                ...
                <div class="pcs-quick-cards">
                    <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="pcs-quick-card">
                            <div class="pcs-card-icon"><?php echo $card['icon'] ?? ''; ?></div>
                            <div class="pcs-card-content">
                                <strong><?php echo e($card['label'] ?? ''); ?></strong>
                                <?php $__currentLoopData = ($card['lines'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="pcs-main-grid">
                ...
                <div class="pcs-form-card">
                    <div class="pcs-form-header">
                        <h3><?php echo e($info['form']['title'] ?? __('website.contact.form_title')); ?></h3>
                        <?php if(!empty($info['form']['subtitle'])): ?>
                            <p class="pcs-subtitle"><?php echo e($info['form']['subtitle']); ?></p>
                        <?php endif; ?>
                    </div>

                    <?php if(session('contact_status')): ?>
                    ...
                    <form method="POST" action="<?php echo e(route('website.contact.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="pcs-form-grid">
                            <div class="pcs-form-row">
                                <div class="pcs-form-group">
                                    <label for="pcs_name"><?php echo e($info['form']['fields']['name'] ?? __('website.contact.fields.name')); ?></label>
                                    <input id="pcs_name" type="text" name="name" value="<?php echo e(old('name')); ?>" required>
                                    <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                        <div class="pcs-error"><?php echo e($message); ?></div>
                                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="pcs-form-group">
                                    <label for="pcs_email"><?php echo e($info['form']['fields']['email'] ?? __('website.contact.fields.email')); ?></label>
                                    <input id="pcs_email" type="email" name="email" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="pcs-form-group">
                                <label for="pcs_phone"><?php echo e($info['form']['fields']['phone'] ?? __('website.contact.fields.phone')); ?></label>
                                <input id="pcs_phone" type="text" name="phone" value="<?php echo e(old('phone')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="pcs-form-group">
                                <label for="pcs_message"><?php echo e($info['form']['fields']['message'] ?? __('website.contact.fields.message')); ?></label>
                                <textarea id="pcs_message" name="message" required><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <button type="submit" class="pcs-submit-btn">
                            <span><?php echo e($info['form']['button'] ?? __('website.contact.submit')); ?></span>
                ...
                <div class="pcs-map-card">
                    <div class="pcs-map-header">
                        <h3><?php echo e($info['map']['title'] ?? __('website.contact.map_title')); ?></h3>
                        <?php if(!empty($info['map']['subtitle'])): ?>
                            <p class="pcs-subtitle"><?php echo e($info['map']['subtitle']); ?></p>
                        <?php else: ?>
                            <p class="pcs-subtitle"><?php echo e($info['map']['description'] ?? __('website.contact.map_description')); ?></p>
                        <?php endif; ?>
                    </div>
...
<?php endif; ?><?php /**PATH C:\Users\iuser\Desktop\PROJECTS\BNB PROJECT\bnbbackendlaravel\resources\views/websitepages/components/contact-section.blade.php ENDPATH**/ ?>