...
class AdminChattingController extends Controller
{
     ...
     *     @OA\Response(response=401, description="Unauthorized"), @OA\Response(response=404, description="Chat not found"), @OA\Response(response=500, description="Server error"))
     */
