    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Create New Room - {{ $motel->name }}</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('bnbowner.room-management.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="status" name="status" required>
                                                <option value="free" {{ old('status', 'free') == 'free' ? 'selected' : '' }}>Free</option>
                                                <option value="booked" {{ old('status') == 'booked' ? 'selected' : '' }}>Booked</option>
                                                <option value="maintainace" {{ old('status') == 'maintainace' ? 'selected' : '' }}>Maintenance</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
