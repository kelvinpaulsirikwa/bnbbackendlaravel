    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Add New Staff Member - {{ $motel->name }}</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('bnbowner.staff-management.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="role" name="role" required>
                                                ...
                                                <option value="bnbreceiptionist" {{ old('role') == 'bnbreceiptionist' ? 'selected' : '' }}>
                                                    <i class="fas fa-user-tie"></i> Receptionist
                                                </option>
                                                <option value="bnbsecurity" {{ old('role') == 'bnbsecurity' ? 'selected' : '' }}>
                                                    <i class="fas fa-shield-alt"></i> Security
                                                </option>
                                                <option value="bnbchef" {{ old('role') == 'bnbchef' ? 'selected' : '' }}>
