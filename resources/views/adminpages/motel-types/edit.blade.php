            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Update motel type information</p>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('adminpages.motel-types.update', $motelType->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bx bx-save"></i> Update Motel Type
                                        </button>
                                    </div>
                                </div>
                            </div>
