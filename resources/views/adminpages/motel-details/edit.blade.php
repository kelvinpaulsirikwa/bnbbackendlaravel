            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Update motel detailed information</p>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('adminpages.motel-details.update', $motelDetail->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select @error('motel_id') is-invalid @enderror" 
                                        ...
                                        @foreach($motels as $motel)
                                            <option value="{{ $motel->id }}" {{ old('motel_id', $motelDetail->motel_id) == $motel->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('district_id') is-invalid @enderror" 
                                        ...
                                        @foreach($districts as $district)
                                            <option value="{{ $district->id }}" {{ old('district_id', $motelDetail->district_id) == $district->id ? 'selected' : '' }}>
                                                {{ $district->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="street_address" 
                                           name="street_address" 
                                           value="{{ old('street_address', $motelDetail->street_address) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="latitude" 
                                           name="latitude" 
                                           value="{{ old('latitude', $motelDetail->latitude) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="longitude" 
                                           name="longitude" 
                                           value="{{ old('longitude', $motelDetail->longitude) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($motelDetail->front_image)
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <img src="{{ asset($motelDetail->front_image) }}" alt="Current front image" class="img-thumbnail" style="max-width: 150px; max-height: 150px;">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <input type="file" 
                                           ...
                                           accept="image/*">
                                    <div class="form-text">
                                        Upload a new front image (JPEG, PNG, JPG, GIF, SVG - Max 2MB). Leave empty to keep current image.
                                    </div>
                                    @error('front_image')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="total_rooms" 
                                           name="total_rooms" 
                                           value="{{ old('total_rooms', $motelDetail->total_rooms) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('available_rooms', $motelDetail->available_rooms) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="rate" 
                                           name="rate" 
                                           value="{{ old('rate', $motelDetail->rate) }}" 
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bx bx-save"></i> Update Motel Details
                                        </button>
                                    </div>
                                </div>
                            </div>
