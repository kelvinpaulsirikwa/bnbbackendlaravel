...
<div class="container-fluid py-4" style="background-color: #f8f9fa; min-height: 100vh;">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Welcome back, {{ auth()->user()->username ?? auth()->user()->useremail }}</p>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold">{{ number_format($bnbUserStats['total']) }}</h2>
                        </div>
                    ...
                    <div class="mt-2">
                        <span class="badge bg-success me-1">{{ $bnbUserStats['active'] }} Active</span>
                        <span class="badge bg-warning">{{ $bnbUserStats['inactive'] }} Inactive</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold">{{ number_format($bnbUserStats['today']) }}</h2>
                        </div>
                    ...
                    <div class="mt-2 small text-muted">
                        <i class="fas fa-clock me-1"></i>Yesterday: {{ $bnbUserStats['yesterday'] }}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold">{{ number_format($bnbUserStats['this_month']) }}</h2>
                        </div>
                    ...
                    <div class="mt-2 small text-muted">
                        <i class="fas fa-globe me-1"></i>Website Signups: {{ $bnbUserStats['website_registrations'] }}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold">{{ number_format($customerStats['total']) }}</h2>
                        </div>
                    ...
                    <div class="mt-2 small text-muted">
                        <i class="fas fa-plus-circle me-1"></i>Today: {{ $customerStats['today'] }} | This Month: {{ $customerStats['this_month'] }}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-3">
                            <div class="border rounded p-3">
                                <h3 class="mb-0 fw-bold text-primary">{{ $motelStats['total'] }}</h3>
                                <small class="text-muted">Total</small>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="border rounded p-3">
                                <h3 class="mb-0 fw-bold text-success">{{ $motelStats['active'] }}</h3>
                                <small class="text-muted">Active</small>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="border rounded p-3">
                                <h3 class="mb-0 fw-bold text-warning">{{ $motelStats['inactive'] }}</h3>
                                <small class="text-muted">Inactive</small>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="border rounded p-3">
                                <h3 class="mb-0 fw-bold text-info">{{ $motelStats['pending'] }}</h3>
                    ...
                    <div class="mt-3 pt-3 border-top">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-warning fs-6">{{ $motelStats['inactive'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row text-center">
                        <div class="col-4">
                            <div class="border rounded p-3 bg-light">
                                ...
                                <h3 class="mb-0 fw-bold">{{ $locationStats['countries'] }}</h3>
                        ...
                        <div class="col-4">
                            <div class="border rounded p-3 bg-light">
                                ...
                                <h3 class="mb-0 fw-bold">{{ $locationStats['regions'] }}</h3>
                        ...
                        <div class="col-4">
                            <div class="border rounded p-3 bg-light">
                                ...
                                <h3 class="mb-0 fw-bold">{{ $locationStats['districts'] }}</h3>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-warning">{{ $pendingMotels->count() }}</span>
                </div>
                <div class="card-body p-0">
                    @if($pendingMotels->count() > 0)
                        <div class="list-group list-group-flush">
                            @foreach($pendingMotels as $motel)
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="mb-1">{{ $motel->name }}</h6>
                                        <small class="text-muted">
                                            <i class="fas fa-user me-1"></i>{{ $motel->owner->username ?? 'N/A' }}
                                            <span class="mx-1">•</span>
                                            <i class="fas fa-map-marker-alt me-1"></i>{{ $motel->district->name ?? 'N/A' }}
                                        </small>
                                    </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-success">{{ $bnbUserStats['website_registrations'] }} total</span>
                </div>
                <div class="card-body p-0">
                            ...
                            @foreach($recentRegistrations as $user)
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted">
                                            <i class="fas fa-envelope me-1"></i>{{ $user->useremail }}
                                            <span class="mx-1">•</span>
