            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Update region information</p>
                    </div>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('adminpages.regions.update', $region) }}" id="regionForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <select name="countryid" 
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}" {{ old('countryid', $region->countryid) == $country->id ? 'selected' : '' }}>
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                                </select>
