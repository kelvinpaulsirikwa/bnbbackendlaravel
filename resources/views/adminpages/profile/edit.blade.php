...
<div class="container py-4">
    <div class="row">
        <div class="col-12">
            <div class="mb-4">
                <h2 class="fw-semibold">Admin Profile Management</h2>
                <p class="text-muted mb-0">Update your basic details, profile picture, and password.</p>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body text-center">
                    ...
                    <form action="{{ route('adminpages.profile.update-avatar') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="col-lg-8 d-flex flex-column gap-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('adminpages.profile.update') }}" method="POST">
                        @csrf
                        <div class="mb-3">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('adminpages.profile.update-password') }}" method="POST">
                        @csrf
                        <div class="mb-3">
