            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Add a new motel to the system</p>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('adminpages.motels.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              name="description" 
                                              rows="3" 
                                              placeholder="Enter motel description">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('motel_type_id') is-invalid @enderror" 
                                        ...
                                        @foreach($motelTypes as $motelType)
                                            <option value="{{ $motelType->id }}" {{ old('motel_type_id') == $motelType->id ? 'selected' : '' }}>
                                                {{ $motelType->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bx bx-save"></i> Create Motel
                                        </button>
                                    </div>
                                </div>
                            </div>
