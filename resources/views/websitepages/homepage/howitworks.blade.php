...
<section class="hiw-section">
    ...
    <div class="hiw-container">
        <div class="hiw-header">
            ...
            <h2 class="hiw-title">{{ $stepsTitle }}</h2>
            <p class="hiw-subtitle">{{ $stepsSubtitle }}</p>
        </div>
        ...
        <div class="hiw-steps">
            ...
            <div class="hiw-step">
                ...
                <div class="hiw-card">
                    ...
                    <h3 class="hiw-card-title">{{ $step1Title }}</h3>
                    <p class="hiw-card-desc">{{ $step1Desc }}</p>
                </div>
            </div>
            ...
            <div class="hiw-step">
                ...
                <div class="hiw-card">
                    ...
                    <h3 class="hiw-card-title">{{ $step2Title }}</h3>
                    <p class="hiw-card-desc">{{ $step2Desc }}</p>
                </div>
            </div>
            ...
            <div class="hiw-step">
                ...
                <div class="hiw-card">
                    ...
                    <h3 class="hiw-card-title">{{ $step3Title }}</h3>
                    <p class="hiw-card-desc">{{ $step3Desc }}</p>
                </div>
            </div>
        </div>
    </div>
